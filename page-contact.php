      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="entry-content">
          ...
          <div class="contact-address">
            ...
            <h4 class="contact-address__title">MultiMotors</h4>
          ...
          <div class="contact-form">
            <h4 class="contact-form__title">Envíenos su consulta</h4>
            <p class="contact-form__info">Todos los campos son obligatorios</p>
            <?php echo do_shortcode('[contact-form-7 id="2981" title="contacto"]'); ?>
          </div>

          <div class="contact-map">
            <h4 class="contact-map__title">Donde estamos</h4>
            <div class="contact-map__google">
